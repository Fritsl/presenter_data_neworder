/*
  ...
  1. Changes
    - Implements recursive note deletion without using a CTE
    - Uses a more efficient approach to avoid stack depth issues
    - Handles cleanup of note images
    - Updates project metadata

  2. Functions
    - `delete_note_tree`: Deletes a note and all its descendants
      - Uses a loop-based approach instead of recursion
      - Handles cleanup of note images
      - Updates project metadata
*/
